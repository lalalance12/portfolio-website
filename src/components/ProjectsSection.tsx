...
export default function ProjectsSection() {
  ...
  const projects = [
    ...
    // 3. LikAI - Competition project (WCHL Global Finale)
    {
      id: "likai",
      title: "LikAI – AI-Powered Shrimp Farm Compliance Platform",
      description:
      ...
      features: [
        ...
        "24/7 chatbot support for biosecurity guidance",
        "Real-time supply chain monitoring dashboard",
        "Automated compliance reporting for export accreditation",
        "On-chain NFT certification for verifiable credentials",
        "Internet Identity authentication (ICP)",
        "Migrated from Next.js to Vite React for better performance",
      ],
      achievements: [
        "Advanced to WCHL 2025 Global Finale (Top 30% globally)",
        "Built on Internet Computer Protocol blockchain",
        "Integrated LangChain + Grok API for AI chatbot",
      ],
    },
    // 4. Guideon - Featured academic project
    {
      id: "guideon-chatbot",
  ...
  return (
    <section id="projects" className="w-full px-8 py-24 bg-white relative">
        ...
        <FadeContent blur={true} duration={1000} delay={800}>
          <div className="mt-16 mb-12">
            <div className="relative">
              ...
              <div className="relative bg-white/95 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-slate-200 shadow-2xl">
                <div className="text-center space-y-6">
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="relative">
                      ...
                      <svg
                        className="relative w-16 h-16 text-slate-700"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                      >
                  ...
                  <div className="flex justify-center pt-4">
                    ...
                    >
                      <a
                        ...
                        className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                      >
                        <svg
